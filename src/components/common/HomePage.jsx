...
//       {/* Hero Section */}
//       {/* <section className="bg-blue-400 text-white py-16 px-8 text-center w-full rounded-lg mt-6"> */}
...
//         <Link
//           to="/shop"
//           className="bg-white text-blue-900 px-6 py-3 rounded-lg text-lg font-semibold hover:bg-gray-200 transition-all"
//         >
//           Shop Now
//         </Link>
//       </section>
